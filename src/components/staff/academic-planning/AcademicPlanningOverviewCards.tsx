      ...
      <Card>
        <CardContent className="flex items-center gap-3 p-4">
          ...
          <div>
            ...
            <p className="text-2xl font-bold">{studyPlansCount}</p>
          </div>
        </CardContent>
      </Card>
      <Card>
        <CardContent className="flex items-center gap-3 p-4">
          ...
          <div>
            ...
            <p className="text-2xl font-bold">{selectedCoursesCount}</p>
          </div>
        </CardContent>
      </Card>
      <Card>
        <CardContent className="flex items-center gap-3 p-4">
          ...
          <div>
            ...
            <p className="text-2xl font-bold">{lecturersCount}</p>
          </div>
        </CardContent>
      </Card>
      <Card>
        <CardContent className="flex items-center gap-3 p-4">
          ...
          <div>
            ...
            <p className="text-2xl font-bold">{semestersCount}</p>
          </div>
        </CardContent>
      </Card>
    </div>
