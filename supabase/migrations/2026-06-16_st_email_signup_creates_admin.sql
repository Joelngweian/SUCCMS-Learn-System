...
-- ST-prefixed SUC emails are administrator accounts in this project.
-- This is harmless when no staff rows exist, but keeps the migration safe
-- if a previous environment already created staff profiles.
